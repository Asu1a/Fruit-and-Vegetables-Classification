...
cnn.add(tf.keras.layers.Conv2D(filters=64, kernel_size=3, activation='sigmoid', input_shape=[64, 64, 3]))
...
cnn.add(tf.keras.layers.Dense(units=128, activation='sigmoid')) #Neurons 
...
##Saving Model
cnn.save('trained_model_sigmoid.keras')


##Recording History in json
import json
with open('training_history_sigmoid.json', 'w') as f:
